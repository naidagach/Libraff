...
function Item({activeLang, type='bestseller'}) {
	...
	if (books.length === 0 ) {
		return (
			<div className='flex flex-wrap w-full gap-2'>
				<div className='w-[48%] 3xs:w-[32%] 2xs:w-[49%] xs:w-[30%] sm:w-[24%] l:w-[19%] xl:w-[16%]'>
					<ItemSkeleton />
				</div>
				<div className='w-[48%] 3xs:w-[32%] 2xs:w-[49%] xs:w-[30%] sm:w-[24%] l:w-[19%] xl:w-[16%]'>
					<ItemSkeleton />
		...
		<div className='flex gap-2 flex-wrap w-full'>
			{
				...
				(filterLang.map((item, i) => {
					return (
						<div key={i}
						 	 className='relative group 4xs:w-[48%] 3xs:w-[32%] 2xs:w-[49%] xs:w-[30%] sm:w-[24%] l:w-[19%] xl:w-[16%] h-[485px] flex flex-col justify-evenly p-2 rounded-2xl overflow-hidden hover:shadow-custom'>
							...
							<div className='bg-[#f6f6f8] overflow-hidden rounded-2xl h-[80%] grid place-items-center'>
								<img className=' mx-auto' src={item.imageSource} alt="" />
							</div>
